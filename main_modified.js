...
// Ensure links with the class `kb-article-link` are not affected
$(document).on("click", "a", function (e) {
    if ($(this).hasClass("kb-article-link")) {
        return; // Allow default behavior for specific links
    }
    // Add any additional logic for other links below
});
